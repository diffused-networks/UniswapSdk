...
public class RouteTests
{
    ...
    private readonly Token token0 = new(1, "0x0000000000000000000000000000000000000001", 18, "t0");
    private readonly Token token1 = new(1, "0x0000000000000000000000000000000000000002", 18, "t1");
    private readonly Token token2 = new(1, "0x0000000000000000000000000000000000000003", 18, "t2");
    ...
    public class MidPriceTests
    {
        ...
        public MidPriceTests()
        {
            ...
            pool_0_1 = new Pool(token0, token1, Constants.FeeAmount.MEDIUM, EncodeSqrtRatioX96.Encode(1, 5), 0,
                TickMath.GetTickAtSqrtRatio(EncodeSqrtRatioX96.Encode(1, 5)), new List<int>());
            pool_1_2 = new Pool(token1, token2, Constants.FeeAmount.MEDIUM, EncodeSqrtRatioX96.Encode(15, 30), 0,
                TickMath.GetTickAtSqrtRatio(EncodeSqrtRatioX96.Encode(15, 30)), new List<int>());
            pool_0_weth = new Pool(token0, weth, Constants.FeeAmount.MEDIUM, EncodeSqrtRatioX96.Encode(3, 1), 0,
                TickMath.GetTickAtSqrtRatio(EncodeSqrtRatioX96.Encode(3, 1)), new List<int>());
            pool_1_weth = new Pool(token1, weth, Constants.FeeAmount.MEDIUM, EncodeSqrtRatioX96.Encode(1, 7), 0,
                TickMath.GetTickAtSqrtRatio(EncodeSqrtRatioX96.Encode(1, 7)), new List<int>());
        }
        ...
        public void CorrectFor0To1()
        {
            ...
            Assert.Equal("0.2000", price.ToFixed());
